...
/// A floating question context header for answer details.
///
/// Keeping this as a floating sliver makes the question context behave like a
/// native reading header: it scrolls away with an upward gesture and returns
/// as soon as the user reverses direction, without staying pinned above the
/// answer body.
class AnswerQuestionFloatingHeaderDelegate
    extends SliverPersistentHeaderDelegate {
  const AnswerQuestionFloatingHeaderDelegate({
    required this.title,
    required this.questionId,
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  ...
                  if (overlapsContent) const Color(0xF5FFFFFF),
                ],
              ),
  ...
  @override
  bool shouldRebuild(covariant AnswerQuestionFloatingHeaderDelegate old) =>
      old.title != title ||
