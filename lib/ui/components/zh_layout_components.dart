...
/// follow the drawer progress so they ease into the square edge while the
/// sidebar moves, then return to the normal rounded viewport when it closes.
...
class ZhMobileViewportSurface extends StatelessWidget {
  ...
  @Deprecated('Use drawerProgress for animated sidebar transitions.')
  ...
  Widget build(BuildContext context) {
    ...
    if (visible == null) return _buildSurface(child, 0);
    return ValueListenableBuilder<bool>(
      valueListenable: visible,
      child: child,
      builder: (context, value, child) => _buildSurface(child!, value ? 1 : 0),
    );
  }
